...
function miInformacion() {
  ...
  const nombre = "Danna Pamela Albertos Sosa";
  const edad = 18;
  const carrera = "Ingenieria en Desarrollo de Software y Negocios Digitales";
...
function tablaMultiplicar(numero) {
  ...
  const tabla = Array.from({ length: 10 }, (_, i) => numero * (i + 1));
  return tabla;
}
 ...
 */
  ...
  // Devuelve una copia invertida del array original
